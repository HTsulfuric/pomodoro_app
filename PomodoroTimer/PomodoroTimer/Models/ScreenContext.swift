...
enum ScreenCategory: CaseIterable {
    ...
    var description: String {
        switch self {
        case .small: return "Small (< 1600px)"
        case .medium: return "Medium (1600-2560px)"
        case .large: return "Large (2560-3840px)"
        case .ultraWide: return "Ultra-wide (> 3840px or wide aspect)"
        }
    }
}
