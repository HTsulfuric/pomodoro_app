...
extension ThemeExperience {
    ...
    func makeFullLayoutView(viewModel _: AppCoordinator, statusInfo _: StatusInfo, rippleTrigger _: Binding<Bool>) -> AnyView? {
        nil
    }

    /// Default implementation returns nil (use standard keyboard behavior)
    func customKeyboardBehavior(for _: UInt16) -> KeyboardBehavior? {
        nil
    }
...
struct AnyThemeExperience {
    ...
    init(_ experience: some ThemeExperience) {
