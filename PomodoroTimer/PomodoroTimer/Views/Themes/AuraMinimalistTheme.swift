...
struct AuraMinimalistExperience: ThemeExperience {
    ...
    @ViewBuilder
    func makeControlsView(viewModel _: AppCoordinator) -> some View {
...
struct MinimalControlButton: View {
    ...
    private var buttonColor: Color {
        if isPrimary {
            switch viewModel.pomodoroState.currentPhase {
            case .work:
                Color(red: 0 / 255, green: 82 / 255, blue: 204 / 255) // Atlassian Blue
            case .shortBreak, .longBreak:
                Color(red: 54 / 255, green: 179 / 255, blue: 126 / 255) // Atlassian Green
            }
        } else {
            Color(red: 151 / 255, green: 160 / 255, blue: 175 / 255) // Atlassian Gray
        }
    }
}
